...
def bdd_avec_donnees(bdd_temporaire):
    ...
    c = connexion.cursor()
    c.execute("INSERT INTO sessions VALUES ('s1','ordinateur',1920,1080,'Chrome 120','/actualites',datetime('now'))")
    c.execute("INSERT INTO sessions VALUES ('s2','mobile',375,812,'Safari 17','/actualites',datetime('now'))")
